...
public class RootConfig implements IModule {
     ...
     * Database info.
     */
    public String host, port, database, user, password, table , consumetable;
    /**
    ...
    private void loadStorageSettings(ConfigurationSection config) {
        ...
        consumetable = config.getString("mysql.consumetable" , "consumetable");
    ...
    public void starting() {
     // Grab config
        ...
        defaults.put("mysql.consumetable", "consumetable");
